...
This repository contains the source code and data for our CoBEVT nuscene track. The whole pipeline is based on [Cross View Transformer CVPR2022](https://github.com/bradyz/cross_view_transformers).
...
```bash
# Clone repo
https://github.com/DerrickXuNu/CoBEVT.git

cd CoBEVT/nuScenes

# Setup conda environment
conda create -y --name cobevt_nuscene python=3.8

conda activate cobevt_nuscene
